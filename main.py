...
rnn = nn.RNN(5, 6, 2, batch_first=True, bidirectional=True)

input = torch.randn(3, 5, 5)
h0 = torch.randn(4, 3, 6, requires_grad=True)
...
rnn2 = nn2.RNN(5, 6, 2, batch_first=True, bidirectional=True)
...
input2 = mytorch.randn(3, 5, 5)

input2.data = input.detach().numpy()

h02 = mytorch.randn(4, 3, 6, requires_grad=True)
